...
clear
box_out 'Sysglance: Initiating System Information gathering' '' 'This is a free software generated by burning hours and passion as a fuel' '' 'Read More at the end'
countdown 5
#----------------------------------------------------------
# Host information
...
echo ""
sleep 1
box_out 'Sysglance : Gathering system information completed' '---------------------------------------------------------' 'This is a free software. If you found it usefull' 'you should consider a donation with Pay-What-You-Want model, in the following link:' '' 'https://ko-fi.com/cerebrux' '' '          Thank you in advance'
