...
echo ""
sleep 1
box_out 'Sysglance : Gathering system information completed' '---------------------------------------------------------' 'This is a free/libre software generated by burning hours and passion as a fuel. If you find it usefull' 'you should consider a donation, in the following link:' '' 'https://paypal.me/cerebrux' '' '          Thank you in advance'
